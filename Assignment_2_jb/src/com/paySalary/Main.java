            ...
            while (true) {
                ...
                if (options == 7) {
                    ...
                    switch (options) {
                        ...
                        case 2:
                            System.out.println();
                            Main.addBalanceToCompany(bankAccount);
                            break;
                        case 3:
                            System.out.println();
                            Main.setLowestSalary(company);
                            break;
                        case 4:
                            System.out.println();
                            Main.fundTransfer(company, bankAccount);
                            break;
                        case 5:
                            System.out.println();
                            Main.printEmployeeInfo(company);
                            break;
                        case 6:
                            System.out.println();
                            Main.printTotalPaidSalaryAndCurrentBalance(company);
                            break;
                        default:
